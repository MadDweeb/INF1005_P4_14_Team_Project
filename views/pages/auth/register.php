        ...
        <form method="POST" action="/register" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?= escapeHtml($username ?? '') ?>" required
                    minlength="3" maxlength="50" autocomplete="username" <?= !empty($errors['username']) ? 'aria-describedby="username-error" aria-invalid="true"' : '' ?>>
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="<?= escapeHtml($email ?? '') ?>" required
                    autocomplete="email" <?= !empty($errors['email']) ? 'aria-describedby="email-error" aria-invalid="true"' : '' ?>>
            ...
            <div class="form-group">
                ...
                <input type="password" id="confirm_password" name="confirm_password" required minlength="8"
                    autocomplete="new-password" <?= !empty($errors['confirm_password']) ? 'aria-describedby="confirm-error" aria-invalid="true"' : '' ?>>
