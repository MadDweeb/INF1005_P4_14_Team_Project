...
<div class="about-page">
    ...
    <div class="about-hero">
        ...
        <p>We're on a mission to help keyboard enthusiasts discover the perfect switches for their ideal typing experience.</p>
    </div>
    ...
    <section class="about-section">
        ...
        <div class="story-content">
            <p>
                KeyForge was born from a simple frustration: finding the right mechanical keyboard switch shouldn't be this hard. 
                As passionate keyboard enthusiasts ourselves, we spent countless hours researching switches, reading reviews, 
    ...
    <section class="about-section">
        ...
        <div class="values-grid">
            <div class="value-card">
                ...
                <h3>Quality First</h3>
                <p>We only stock switches that meet our rigorous quality standards. Every product is tested and verified before it reaches you.</p>
            </div>
            
            <div class="value-card">
                <span class="value-icon">💡</span>
                <h3>Expert Guidance</h3>
                <p>Our team of keyboard enthusiasts provides honest, detailed information to help you make informed decisions.</p>
            </div>
            ...
            <div class="value-card">
                ...
                <p>We're part of the mechanical keyboard community. Your feedback shapes what we stock and how we serve you.</p>
            </div>
            
            <div class="value-card">
                <span class="value-icon">🔧</span>
                <h3>Innovation</h3>
                <p>From our switch customizer to detailed specs, we're constantly building tools to improve your experience.</p>
            </div>
            
            <div class="value-card">
                <span class="value-icon">♻️</span>
                <h3>Sustainability</h3>
                <p>We're committed to reducing waste through minimal packaging and supporting eco-friendly manufacturers.</p>
            </div>
        </div>
    </section>
